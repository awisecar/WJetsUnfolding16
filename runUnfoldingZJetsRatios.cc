...
int main(int argc, char **argv){
    ...
    std::cout << "\n >>>>> Executing UnfoldingZJetsRatios(\"" << lepSel << "\", \"" <<  year << "\", \"" <<  algo << "\", \"" << histoDir << "\", \"" << unfoldDir << "\", " << jetPtMin << ", " << jetEtaMax << ", " << variableNUM << ", " << variableDENOM << ", " << doNormalized << ", " << whichSyst << ");" << std::endl;
    std::cout << " >>>>> Where UnfoldingZJetsRatios(lepSel, year, algo, histoDir, unfoldDir, jetPtMin, jetEtaMax, variableNUM, variableDENOM, doNormalized, whichSyst)" << std::endl;

    UnfoldingZJetsRatios(lepSel, year, algo, histoDir, unfoldDir, jetPtMin, jetEtaMax, variableNUM, variableDENOM, doNormalized, whichSyst);
